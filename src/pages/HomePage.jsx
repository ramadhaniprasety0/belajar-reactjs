      ...
      <header className='w-100 min-vh-100 d-flex align-items-center justify-content-center'>
        <Container>
          <div className='d-flex flex-column align-items-center'>
            <h1 className='montserrat-font fw-bold'>Selamat datang di FindFun!</h1>
            <p>Tempat dimana para cinephile dan audiophile saling bertemu secara online</p>
            <a href="#homepage" className='btn-explore mt-3'>Mulai Berksplorasi</a>
          </div>
        </Container>
      </header>
      <div className="homepage w-100 min-vh-100" id="homepage">
        <div>
          ...
          <Row className="header-box d-flex align-items-center">
            <h1 className="text-start"><b>Populer di FindFun</b></h1>
            <CarouselComponent carouselItems={carouselItems} className="rounded-4" />
          </Row>
          <Row className='box-hits d-flex align-items-center justify-content-center'>
              <Col lg={12}>
                <h1><b>Musik Hits hari ini</b> </h1>
              </Col>
        ...
        <div>
        <Container>
          <Row className='p-3 me-3 box-hits'>
            <Col lg={12}>
              <h1 ><b>Film Terkini</b></h1>
            </Col>
